...
const welcomeFirstCardHeader = document.querySelector(
  "#welcome-first-card-header"
);
const welcomeFirstCardText = document.querySelector("#welcome-first-card-text");
const welcomeSecondCardHeader = document.querySelector(
  "#welcome-second-card-header"
);
const welcomeSecondCardText = document.querySelector(
  "#welcome-second-card-text"
);
const welcomeThirdCardHeader = document.querySelector(
  "#welcome-third-card-header"
);
...
const aboutUsSectionFirstCard = document.querySelector(
  "#about-us-section-first-card"
);
const aboutUsSectionSecondCard = document.querySelector(
  "#about-us-section-second-card"
);
const locationSectionHeader = document.querySelector(
...
var language = {
  eng: {
    ...
    heroSectionText:
      "Sign up and become a Reve deliverer! Drive your own vehicle or choose something from our fleet, deliver full-time or as extra work - you choose!",
    ...
    aboutUsSectionText:
      "More than 300 satisfied active suppliers are the best indicator of our reliable and safe working environment.",
  ...
  hr: {
    ...
    heroSectionText:
      "Prijavi se i postani Reve dostavljač! Vozi svoje vozilo ili odaberi nešto iz naše flote, dostavljaj na puno radno vrijeme ili kao dodatni posao - ti biraš!",
    ...
    aboutUsSectionText:
      "Više od 300 zadovoljnih akitvnih dostavljača najbolji su pokazatelj našeg pouzdanog i sigurnog radnog okruženja.",
    ...
    signUpPageText:
      "<div>Želiš se prijaviti na Wolt ili Glovo? <br> Naš tim će te kontaktirati u najkraćem mogućem roku.</div>",
...
if (sessionStorage.getItem("lang") == "eng") {
  ...
  heroSectionHeader.innerHTML = language.eng.heroSectionHeader;

  heroSectionText.textContent = language.eng.heroSectionText;

  welcomeHeader.textContent = language.eng.welcomeHeader;

  welcomeSubHeader.textContent = language.eng.welcomeSubHeader;

  welcomeFirstCardHeader.textContent = language.eng.welcomeFirstCardHeader;

  welcomeFirstCardText.textContent = language.eng.welcomeFirstCardText;

  welcomeSecondCardHeader.textContent = language.eng.welcomeSecondCardHeader;

  welcomeSecondCardText.textContent = language.eng.welcomeSecondCardText;

  welcomeThirdCardHeader.textContent = language.eng.welcomeThirdCardHeader;

  welcomeThirdCardText.textContent = language.eng.welcomeThirdCardText;

  aboutUsSectionHeader.textContent = language.eng.aboutUsSectionHeader;

  aboutUsSectionText.textContent = language.eng.aboutUsSectionText;

  aboutUsSectionFirstCard.textContent = language.eng.aboutUsSectionFirstCard;

  aboutUsSectionSecondCard.textContent = language.eng.aboutUsSectionSecondCard;

  locationSectionHeader.innerHTML = language.eng.locationSectionHeader;
  ...
  moreButton.forEach(
    (moreButton) => (moreButton.textContent = language.eng.moreButton)
  );
